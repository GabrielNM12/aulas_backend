...
public class ClienteController {
    ...
    @GetMapping("/cliente-desconhecido")
    public ResponseEntity<Collection<Cliente>> buscarEmailDesconhecido() {
        return ResponseEntity.ok(clienteService.listarEmailDesconhecido());
    }
}